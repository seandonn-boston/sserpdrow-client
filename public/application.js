...
var onCreatePosts = function onCreatePosts(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createPosts(data).then(ui.addPostsSuccess).then(onGetPosts).catch(ui.postError);
};

var onGetPosts = function onGetPosts() {
  api.getPosts().then(ui.getPostsSuccess).catch(ui.postError);
};

var onUpdatePosts = function onUpdatePosts(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  var id = $(event.target).data('id');
  api.updatePosts(data, id).then(api.getPosts).then(ui.updatePostsSuccess).catch(ui.postError);
};

var onDeletePosts = function onDeletePosts(event) {
  event.preventDefault();
  var data = $(event.target).data('id');
  api.deletePosts(data).then(ui.deletePostsSuccess).then(onGetPosts).catch(ui.postError);
};
...
var updatePosts = function updatePosts(data, id) {
  return $.ajax({
    method: 'PATCH',
...
var deletePosts = function deletePosts(data) {
  return $.ajax({
    method: 'DELETE',
...
var store = __webpack_require__(6);
var showPostsTemplate = __webpack_require__(15);
...
var revealChangePassSignOut = function revealChangePassSignOut() {
  var authInternal = document.getElementById('authInternal');
  authInternal.classList.remove('hidden');
};

var revealSignUpSignIn = function revealSignUpSignIn() {
  var userAuthExternal = document.getElementById('authExternal');
  userAuthExternal.classList.remove('hidden');
};

var revealCreatePost = function revealCreatePost() {
  var createPost = document.getElementById('create-post-wrapper');
...
var hideSignUpSignIn = function hideSignUpSignIn() {
  var authExternal = document.getElementById('authExternal');
  authExternal.classList.add('hidden');
};

var hideCreatePost = function hideCreatePost() {
  var createPost = document.getElementById('create-post-wrapper');
...
// Post Success
var addPostsSuccess = function addPostsSuccess(data) {
  clearMessageDiv();
  clearFormFields();
};
...
var getPostsSuccess = function getPostsSuccess(data) {
  ...
  var showPostsHtml = showPostsTemplate({ object: data });
  $('.view-posts').empty();
...
var updatePostsSuccess = function updatePostsSuccess(data) {
  clearMessageDiv();
...
var deletePostsSuccess = function deletePostsSuccess(data) {
  $('.delete-post').modal('hide');
  clearMessageDiv();
  clearFormFields();
};

var postError = function postError() {
  clearMessageDiv();
  $('.update-post').modal('hide');
...
var showPost = function showPost(id) {
  $('#post-' + id).modal('show');
};
...
module.exports = {
  ...
  authError: authError,
  addPostsSuccess: addPostsSuccess,
  getPostsSuccess: getPostsSuccess,
  updatePostsSuccess: updatePostsSuccess,
  deletePostsSuccess: deletePostsSuccess,
  postError: postError,
  showPost: showPost
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.signIn(data).then(ui.signInSuccess).then(events.onGetPosts).catch(ui.authError);
};

var onChangePassword = function onChangePassword(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.changePassword(data).then(ui.changePasswordSuccess).catch(ui.authError);
};

var onSignOut = function onSignOut(event) {
  event.preventDefault();
  api.signOut().then(ui.signOutSuccess).then(events.onGetPosts).catch(ui.authError);
};
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://sheltered-tor-82632.herokuapp.com',
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "      <!-- Card -->\n      <div class=\"col-xs-12 col-sm-6 col-md-3 card "
    ...
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.blog : stack1),{"name":"if","hash":{},"fn":container.program(3, data, 0, blockParams),"inverse":container.program(5, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "          <div>\n            <h3 data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + ">"
    ...
    + "</p>\n          </div>\n          <div class=\"btn-group card-buttons\" role=\"group\">\n            <button class=\"btn btn-primary show-more-button "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.owner : stack1), depth0))
    + "\" data-id= "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + " type=\"button\" data-toggle=\"modal\" data-target=\"#post-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">Show All</button>\n            <button class=\"btn btn-primary update-button "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.owner : stack1), depth0))
    + "\" data-id= "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + " type=\"button\" data-toggle=\"modal\" data-target=\".update-post-modal-lg-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">Update</button>\n            <button class=\"btn btn-danger delete-button "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.owner : stack1), depth0))
    + "\" data-id= "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + " type=\"button\" data-toggle=\"modal\" data-target=\".delete-post-modal-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">Delete</button>\n          </div>\n        </div>\n      </div>\n\n      <!-- Update Modal -->\n      <div class=\"post-modal-handlebars update-post modal update-post-modal-lg-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" id=\"update-post-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"updatepost\" aria-hidden=\"true\">\n        <div class=\"modal-dialog modal-lg\">\n          <div class=\"modal-content\">\n            <div class=\"modal-header\">\n              <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                <span aria-hidden=\"true\">&times;</span>\n              </button>\n              <h3 class=\"modal-title\">Update Your post!</h3>\n            </div>\n            <div class=\"modal-body\">\n              <form class=\"update-post-form\" data-id= "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + ">\n                <div class=\"form-group\">\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.blog : stack1),{"name":"if","hash":{},"fn":container.program(7, data, 0, blockParams),"inverse":container.program(9, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "                </div>\n                <div class=\"form-group\">\n                  <label for=\"post-title-update-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">Post Title</label>\n                  <input type=\"text\" class=\"form-control\" id=\"post-title-update-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" name=\"post[title]\" placeholder=\"Enter post title\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "\" required>\n                </div>\n                <div class=\"form-group\">\n                  <label for=\"post-content-update-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">Post Content</label>\n                  <textarea type=\"text\" class=\"form-control\" id=\"post-content-update-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" name=\"post[content]\" placeholder=\"Content goes here!\" rows=\"3\" required>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
    + "</textarea>\n                </div>\n                <button class=\"btn btn-primary update-post\" data-id= "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + " type=\"submit\">Submit</button>\n              </form>\n            </div>\n          </div>\n        </div>\n      </div>\n\n      <!-- Delete Modal -->\n      <div id=\"delete-post-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" class=\"post-modal-handlebars post-modal delete-post modal delete-post-modal-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"deletepost\" aria-hidden=\"true\">\n        <div class=\"modal-dialog modal-lg\">\n          <div class=\"modal-content\">\n            <div class=\"modal-header\">\n              <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n                <span aria-hidden=\"true\">&times;</span>\n              </button>\n              <h3 class=\"modal-title\"> Are you sure you want to Delete?! </h3>\n            </div>\n            <div class=\"modal-body\">\n              <form data-id= "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + " class=\"destroy-post-form\">\n                <button type=\"submit\" class=\"delete-btn btn btn-danger\">Yes, delete</button>\n              </form>\n            </div>\n          </div>\n        </div>\n      </div>\n      <!--  content modal -->\n      <div class=\"show-all-modal modal "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "-content\" tabindex=\"-1\" role=\"dialog\" id=\"post-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">\n        <div class=\"modal-dialog modal-lg\" role=\"document\">\n          <div class=\"modal-content\">\n            <div class=\"modal-header\">\n              <h5 class=\"modal-title\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "</h5>\n"
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.blog : stack1),{"name":"if","hash":{},"fn":container.program(11, data, 0, blockParams),"inverse":container.program(13, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "              <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\">\n          <span aria-hidden=\"true\">&times;</span>\n        </button>\n            </div>\n            <div class=\"modal-body\">\n              <p>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
    + "</p>\n            </div>\n            <div class=\"modal-footer\">\n              <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Close</button>\n            </div>\n          </div>\n        </div>\n      </div>\n\n";
},"3":function(container,depth0,helpers,partials,data) {
    return "            <sub><b>Blog</b></sub>\n";
},"5":function(container,depth0,helpers,partials,data) {
    return "            <sub><b>Website</b></sub>\n";
},"7":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "                    <label class=\"radio-inline\">\n                      <input type=\"radio\" name=\"post[blog]\" id=\"post-blog-update-"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1._id : stack1), depth0))
    + "\" value=\"true\" checked>Blog\n                    </label>\n                    <label class=\"radio-inline\">\n                      <input name=\"post[blog]\" type=\"radio\" id=\"post-page-update-"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1._id : stack1), depth0))
    + "\" value=\"false\">Web Page\n                    </label>\n";
},"9":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1, alias1=container.lambda, alias2=container.escapeExpression;

  return "                    <label class=\"radio-inline\">\n                      <input name=\"post[blog]\" type=\"radio\" id=\"post-blog-update-"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1._id : stack1), depth0))
    + "\" value=\"true\">Blog\n                    </label>\n                    <label class=\"radio-inline\">\n                      <input name=\"post[blog]\" type=\"radio\" id=\"post-page-update-"
    + alias2(alias1(((stack1 = blockParams[1][0]) != null ? stack1._id : stack1), depth0))
    + "\" value=\"false\" checked>Web Page\n                    </label>\n";
  ...
  return "<div class=\"row cards-section\">\n  <div class=\"col-xs-12\">\n    <h1>Blog Posts and Web Pages</h1>\n  </div>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.object : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  <div class=\"col-xs-12\">\n    <hr>\n  </div>\n</div>\n";
